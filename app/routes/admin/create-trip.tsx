...
const CreateTrip = ({ loaderData }: Route.ComponentProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        if (
            ...
            setError('Please provide the values for all fields')
            setLoading(false)
            return
        }
    ...
    const handleChange = (key: keyof TripFormData, value: string | number) => { setFormData({ ...formData, [key]: value }) }
        ...
        <main className="flex flex-col gap-10 pb-20 wrapper">
            ...
            <section className="mt-2.5 wrapper-md">
                <form className="trip-form" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <label htmlFor="location ">Location of the trip</label>
                        <MapsComponent>
                            <LayersDirective>
                                <LayerDirective
                                    shapeData={world_map}
                    ...
                    <footer className="px-6 w-full">
                        <ButtonComponent type="submit"
                            ...
                            disabled={loading}>
                            <img src={`/assets/icons/${loading ? 'loader.svg' : 'magic-star.svg'}`} alt="error" className={cn('size-5', { 'animate-spin': loading })} />
